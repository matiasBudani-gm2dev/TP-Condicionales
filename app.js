...
do{
    numA = prompt("Ingrese un numero: ")
    numA = parseInt(numA)
}while(isNaN(parseInt(numA)) || numA < 1 || numA>1000)
mensajeMultiplo = numA + ""
numA % 2 === 0 ? mensajeMultiplo += " es par": mensajeMultiplo += " es impar"
mensajeMultiplo += ", es divisible por:"
numA % 5 === 0 ? mensajeMultiplo += "\n5": null 
numA % 3 === 0 ? mensajeMultiplo += "\n3": null
numA % 2 === 0 ? mensajeMultiplo += "\n2": null
mensajeMultiplo.endsWith("es divisible por:") ? 
mensajeMultiplo = mensajeMultiplo.replace(", es divisible por:", "") : null
